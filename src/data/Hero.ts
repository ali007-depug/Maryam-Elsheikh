    ...
    floatingIcons: [
      {
        src: "write4.svg",
        alt: "icon",
        className: "absolute w-10 top-18 left-[10px]",
        animation: "custom",
        duration: 3,
      },
      {
        src: "write3.svg",
        alt: "icon",
        className: "absolute w-10 bottom-20 right-[-5px] z-1",
        animation: "rotate",
        duration: 4,
      },
      {
        src: "write1.svg",
        alt: "icon",
        className: "absolute w-10 bottom-12  left-5",
        animation: "scale",
        duration: 3,
      },
      {
        src: "write2.svg",
        alt: "icon",
        className: "absolute w-10 top-18 z-11 right-0",
        animation: "fade",
        duration: 5,
      },
    ],
